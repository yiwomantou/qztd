...
# import jieba
from mysql_server import MongoDBserver
    ...
    def get_data(self, asin_list, country, timestamp, ad, keyword, category_name='', category_url=''):
        ...
        for asin in asin_list:
            ...
            result = self.collection.find_one(
                {"asin": asin, "country": "%s" % country, "timestamp": {"$gte": timestamp}})
            if result != None:
...
def keyword_data(country, keyword, category_name='', category_url=''):
    ...
    print(len(asin_list), '===')
    data_list, category_first, category_next = g.get_data(asin_list, country, timestamp, ad, keyword, category_name,
                                                          category_url)
    print(len(data_list), '=====================')
...
if __name__ == '__main__':
    ...
    keyword_data(country='fr', keyword='chargeur secteur')
